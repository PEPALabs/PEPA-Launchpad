...
Thanks for your interest in contributing to PEPA! This document outlines the process for installing dependencies and setting up PEPA for development, as well as some conventions on contributing to PEPA.

## Finding Something to Work On

There are many ways in which you may contribute to the PEPA project, some of which involve coding knowledge and some which do not. A few examples include:
